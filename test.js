...
function priceFor(item) {
  const PRICES = { wumiguo: { "韭菜味": 8, "菜脯味": 10, "土豆味": 10, "玉米味": 10, "南瓜味": 10, "红萝卜": 10, "香芋味": 12, "紫薯味": 11, "竹笋味": 11, "芋泥咸蛋味": 12 },
    ...
    others: { "香芋条": 12, "土豆条": 12, "蔬菜春卷": 16, "芋泥春卷": 16, "粿肉": 22, "韭黄虎皮卷": 22, "韭黄虾卷": 25, "虾饺": 22, "香芋饼": 14, "土豆饼": 14, "萝卜饼": 14, "菜头丸": 11, "小南瓜芋泥": 13, "紫菜卷": 22, "红桃粿": 2.5, "辣椒水": 8, "小米": 12, "小土豆": 12, "小桃粿": 14, "韭菜春卷": 17, "海丰小米": 12, "菜粿": 12, "三角虾酥": 12, "墨鱼虾排": 16, "辣椒酱": 35, "生紫菜卷": 16, "鲜虾春卷": 18, "芋泥油粿": 15 } };
...
const cases = [
  ...
  { name: '账单100 果肉别名=粿肉(22)', text: '果肉1',
    pre: () => api.saveCustomList([]),
    expect: { total: 22, lines: ['others|粿肉 1斤 ¥22'], unknown: [] } },
  { name: '账单101 鲜虾春卷=18/斤(36)', text: '鲜虾春卷2',
    pre: () => api.saveCustomList([]),
    expect: { total: 36, lines: ['others|鲜虾春卷 2斤 ¥36'], unknown: [] } },
  { name: '账单102 芋泥油粿=15/斤(30)', text: '芋泥油粿2',
    pre: () => api.saveCustomList([]),
    expect: { total: 30, lines: ['others|芋泥油粿 2斤 ¥30'], unknown: [] } },
  { name: '账单103 结构化订单(序号+星号+馅字+分类标题)(678)', text: '无米粿:\n⒈韭菜馅 *5\n⒉菜脯馅 *5\n⒊土豆馅 *5\n⒋香芋馅 *5\n\n 水晶球: \n⒈红豆馅*5\n⒉紫薯馅*5\n⒊香芋馅*5\n⒋菜脯馅*5\n\n春卷:\n⒈韭菜春卷 *2\n⒉蔬菜春卷 *2\n⒊芋泥春卷 *2\n⒋鲜虾春卷 *2\n  \nC:芋泥油粿 *2\nD:墨鱼虾排  *2\n\n⒈香芋饼 *1\n⒉菜头饼 *1\n⒊土豆饼 *1',
    pre: () => api.saveCustomList([]),
    expect: { total: 678, lines: ['wumiguo|韭菜味 5斤 ¥40', 'wumiguo|菜脯味 5斤 ¥50', 'wumiguo|土豆味 5斤 ¥50', 'wumiguo|香芋味 5斤 ¥60', 'shuijingqiu|红豆 5斤 ¥60', 'shuijingqiu|紫薯 5斤 ¥60', 'shuijingqiu|香芋 5斤 ¥60', 'shuijingqiu|菜脯 5斤 ¥60', 'others|韭菜春卷 2斤 ¥34', 'others|蔬菜春卷 2斤 ¥32', 'others|芋泥春卷 2斤 ¥32', 'others|鲜虾春卷 2斤 ¥36', 'others|芋泥油粿 2斤 ¥30', 'others|墨鱼虾排 2斤 ¥32', 'others|香芋饼 1斤 ¥14', 'others|萝卜饼 1斤 ¥14', 'others|土豆饼 1斤 ¥14'], unknown: [] } },
];
